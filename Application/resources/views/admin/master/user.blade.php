<div class="w-full h-[86vh] p-1">
    <div
        class="flex flex-col md:flex-row justify-between items-center bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6 gap-4">
        <div>
            ...
            <table id="datatables" class="w-full text-left border-collapse">
                <thead>
                    <tr class="text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-100">
                        ...
                        <th class="px-4 py-4 bg-gray-50/50">Image</th>
                        <th class="px-4 py-4 bg-gray-50/50">Name</th>
                        <th class="px-4 py-4 bg-gray-50/50">Email</th>
                        <th class="px-4 py-4 bg-gray-50/50">Nama Toko</th>
